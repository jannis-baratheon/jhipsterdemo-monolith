...
import it.januszwisniowski.jhipsterpresentation.examples.monolith.service.BookService;
...
import static it.januszwisniowski.jhipsterpresentation.examples.monolith.web.rest.TestUtil.createFormattingConversionService;
...
public class BookResourceIntTest {
    ...
    private static final LocalDate DEFAULT_PUBLISHED_ON = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_PUBLISHED_ON = LocalDate.now(ZoneId.systemDefault());
    ...
    public void createBook() throws Exception {
        ...
        assertThat(testBook.getPublishedOn()).isEqualTo(DEFAULT_PUBLISHED_ON);
    }
    ...
    public void getAllBooks() throws Exception {
        ...
        restBookMockMvc.perform(get("/api/books?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].publishedOn").value(hasItem(DEFAULT_PUBLISHED_ON.toString())));
    }
    ...
    public void getBook() throws Exception {
        ...
        restBookMockMvc.perform(get("/api/books/{id}", book.getId()))
            ...
            .andExpect(jsonPath("$.publishedOn").value(DEFAULT_PUBLISHED_ON.toString()));
    }
    ...
    public void updateBook() throws Exception {
        ...
        assertThat(testBook.getPublishedOn()).isEqualTo(UPDATED_PUBLISHED_ON);
    }
